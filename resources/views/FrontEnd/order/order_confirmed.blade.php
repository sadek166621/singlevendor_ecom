...
{{--                            <img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}" style="max-width: 200px !important;">--}}
                ...
                <td width="120px">
                    ...
                    <div class="tm_shape_bg tm_accent_bg_10 tm_border tm_accent_border_20" style="width: 33%"></div>
                </td>
            ...
            <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                <div class="">
                    <table class="tm_mb15 tm_m0_md" style="border:none !important">
                        ...
                        <tr>
{{--                            <td colspan="3" class="tm_border_none "><p class="tm_m0">Payment Method: Cash On Delivery</p></td>--}}
                            <td class="tm_width_3 tm_danger_color tm_border_none tm_pt0">Discount</td>
                            <td colspan="2" class="tm_width_3 tm_danger_color tm_text_right tm_border_none tm_pt0">- {{$order->discount}} TK</td>
                        </tr>
                        <tr>
...
<footer style="position: fixed; bottom: 30px;">
    <table>
        ...
        <tr style="padding-top: 100px">
            <td colspan="5" style="margin-right: 80px !important;">
            ...
            <td align="right">
                ...
                @if($logo != null)
                    <div style="display: inline; align-items: center">
                        <img src="data:image/png;base64,{{base64_encode(file_get_contents(base_path('public/'.get_setting('site_favicon')->value)))}} " style="width: 50px; margin-bottom: -5px; height: 50px" alt="{{ env('APP_NAME') }}"><span style="color: #F7941E; font-size: 50px; font-weight: 500">OKCHO</span>
                    </div>
                @else
