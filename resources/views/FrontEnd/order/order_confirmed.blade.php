            ...
            <td align="right">
                @if($logo != null)
                    <div style="display: inline; align-items: center">
                        <img align="right" src="data:image/jpg;base64,{{base64_encode(file_get_contents(get_setting('site_favicon')->value))}} " style="margin-top: -18px"  height="50px" width="50px"><span style="color: #F7941E; font-size: 50px; font-weight: 500">OKCHO</span>
