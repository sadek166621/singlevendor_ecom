<footer class="footer">
    ...
    <div class="container">
        <div class="footer-bottom mt-20">
          <div class="row">
            <div class="col-lg-6 col-md-12 text-center text-lg-start"><span class="color-gray-900 font-sm">{{ get_setting('copy_right')->value }} | Developed By <a href="https://skydreamit.com/">Sky Dream IT</a></span></div>
