    ...
    <div class="row">
        <div class="col-md-12">
            <div class="content-header">
                <h3 class="content-title">Campaign list <strong style="font-weight: bold" class=" text-dark"> {{ count($campaings) }} Campaigns Found </strong></h3>
                <div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                  <a href="{{ route('campaing.active',['id'=>$campaing->id]) }}" > <span class="status badge rounded-pill alert-danger">Disable</span></a>
                                @endif
                            </td>
                            <td class="text-end">
